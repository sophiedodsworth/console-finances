...
console.log("Total Months: " + finances.length); // print out the total number of months included in the dataset

var sum = 0; // declaring the sum variable

for (var i = 0; i < finances.length; i++) { // for loop to calculate the net amount of profit/losses over the entire period
